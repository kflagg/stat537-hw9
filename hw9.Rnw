...
<<paths, cache=TRUE, dependson='het.plot'>>=
semPaths(het.cfa, "par")

@

<<paths, cache=TRUE, dependson='cfa'>>=
par(mar = c(0, 0, 0, 0))
semPaths(cfa.model1, what = 'par', edge.label.cex = 1.5, sizeMan = 10, sizeLat = 12)
@
...
\item %b
The root mean square error of approximation is estimated to be 0.099. This exceeds the rule-of-thumb threshold of 0.05, suggesting that there is room for improvement in the model fit.
