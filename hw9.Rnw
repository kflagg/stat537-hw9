...
For weakly correlated variables (with correlations under 0.4), the Pearson and polychoric correlations are very similar. For moderate and strong correlations (above 0.4), the polychoric correltions are slightly larger.
